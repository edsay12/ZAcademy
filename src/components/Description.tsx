...
function Description({ children, title = "aaaaaaaaaaaaaaaa" }: proptypes) {
  ...
  return (
    <>
      <div className="w-full pt-0">
        ...
        {showReadMoreButton && (
          <div className={` ${isOpen && 'bg-gradient-to-b to-white from-transparent'}  z-50 h-32 flex items-end -mt-20 relative`}>
            <button
              className="text-black mt-5 flex items-center gap-2 ml-4"
